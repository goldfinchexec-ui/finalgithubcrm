...
class AppRadius {
  ...
  // Shadcn-inspired default corner radius used by components
  static const double shad = 12.0;
}
...
/// Shared app color tokens (Shadcn-inspired slate palette)
class AppColors {
  // Neutral slate scale
  ...
  // Semantic accents
  static const Color primary = Color(0xFF5B7C99); // primary brand color
  static const Color danger = Color(0xFFDC2626); // Tailwind red-600
  static const Color success = Color(0xFF16A34A); // Tailwind green-600
  static const Color amberSoft = Color(0xFFFFF3C4); // soft amber background
  static const Color emeraldSoft = Color(0xFFD1FAE5); // soft green background
  static const Color roseSoft = Color(0xFFFFE4E6); // soft red background

  // UI tokens
  static const Color border = Color(0xFFE2E8F0); // neutral border
  static const Color sidebar = Color(0xFF0F172A); // slate-900 for sidebar
}
...
class LightModeColors {
  ...
  // Set surface to pure white so all cards/tables (which use surface) are white
...
ThemeData get lightTheme => ThemeData(
  useMaterial3: true,
  // Remove legacy ripple/splash across the app for a cleaner, modern feel
